...
//           // FIXED: Disable foreign key checks temporarily, delete, then re-enable
...
//             // Now delete from main employees table
//             const deleteSql = 'DELETE FROM employees WHERE id = ?';
            
//             db.query(deleteSql, [id], function(deleteErr, deleteResult) {
//               // IMPORTANT: Re-enable foreign key checks regardless of delete result
