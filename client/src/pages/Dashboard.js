...
//           {/* onClick={() => navigate('/employees/add')} style={{cursor: 'pointer'}} */}
...
//                         <span className="text">{emp.salary.toLocaleString()}/month</span>
//                       </div>
//                     )}
//                   </div>
...
// // after the password verification for deleting the records

//After the avatar Change with the Employee ID
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { getAllEmployees, logout, getCurrentUser, deleteEmployee } from '../services/api';
import './Dashboard.css';
