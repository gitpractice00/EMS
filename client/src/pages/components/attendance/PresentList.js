// File: client/src/components/attendance/PresentList.js
import React from 'react';
import { ReactComponent as ArrowLeftIcon } from '../../assets/icons/ArrowLeft.svg';
import { ReactComponent as EmptyBoxIcon } from '../../assets/icons/EmptyBox.svg';

function PresentList({ employees, onBack }) {
  return (
    <section className="attendance-section">
      <div className="details-header attendance-view">
        <h2 className="details-title">Present Employees List</h2>
        ...
        <div className="attendance-list">
          {employees.map(emp => (
            <div key={emp.id} className="attendance-card">
              ...
              <div className="status-label present">
                Present
              </div>
            </div>
          ))}
